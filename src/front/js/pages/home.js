			...
			<section id="body-1">
				<div className="container" id="container-Tipos" >
					<div className="row" id="tipos">
						<div className="col-md-4" id="tipo-1">
							<Tipos
						...
						<div className="col-md-4" id="tipo-2">
							<Tipos
								title="Front-End"
						...
						<div className="col-md-4" id="tipo-3">
							<Tipos
								title="Back-End"
						...
						<div className="col-md-4" id="tipo-4">
							<Tipos
						...
						<div className="col-md-4 py-3" id="tipo-5">
							<Tipos
						...
						<div className="col-md-4 py-3" id="tipo-6">
							<Tipos
								title="Data Base"
