      ...
      <Formik
        ...
        validate={(valores) => {
          ...
          if (!valores.fotorut) {
            ...
            errores.fotorut =
              "Por favor verifica que tu archivo sea .jpg o .pdf";
          }
          ...
          if (!valores.contraseña) {
            ...
            errores.contraseña =
              "Al menos un número entre [0-9], al menos una letra minuscula, al menos una letra mayuscula, al menos un simbolo [*.!@#$%^&(){}[], que tenga entre 8 y 32 caracteres";
          }
        ...
        {({ errors }) => (
          <Form className="formulario">
            ...
            <div>
              ...
              <ErrorMessage
                name="rut"
                component={() => <div className="error">{errors.rut}</div>}
              />
            </div>
            <div>
              <label htmlFor="foto del rut">
                Foto del Rut (solo formato .jpg o .pdf)
              </label>
              <Field type="file" name="fotorut" id="fotoRut" />
              <ErrorMessage
                name="fotorut"
                component={() => <div className="error">{errors.fotorut}</div>}
              />
            </div>
            <div>
            ...
            <div>
              ...
              <ErrorMessage
                name="región"
                component={() => <div className="error">{errors.región}</div>}
              />
            </div>
            <div>
              ...
              <ErrorMessage
                name="ciudad"
                component={() => <div className="error">{errors.ciudad}</div>}
              />
            </div>
          </Form>
        )}
      ...
      <Formik
        ...
        validate={async (valores) => {
          ...
          if (!valores.nombre_institución) {
            ...
            !/^[a-zA-Z0-9_.+-]{1,40}$/.test(valores.nombre_institución)
          ) {
      ...
      >
        {({ errors }) => (
          <Form className="formulario2">
            ...
            <div>
              <label htmlFor="nombre_institución">
                Nombre de Instituto, Universidad o Plataforma
              </label>
              <Field
                type="text"
              ...
              <ErrorMessage
                name="nombre_institución"
                component={() => (
                  <div className="error">{errors.nombre_institución}</div>
                )}
              />
            </div>
            <div>
              ...
              <ErrorMessage
                name="certificado"
                component={() => (
                  <div className="error">{errors.certificado}</div>
                )}
              />
            </div>
            <div>
              ...
              <ErrorMessage
                name="githubuser"
                component={() => (
                  <div className="error">{errors.githubuser}</div>
                )}
              />
            ...
            <div>
              ...
              <ErrorMessage
                name="herramientas"
                component={() => (
                  <div className="error">{errors.herramientas}</div>
                )}
              />
            </div>
